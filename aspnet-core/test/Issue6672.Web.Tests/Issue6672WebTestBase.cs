...
{
    public abstract class Issue6672WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Issue6672WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Issue6672WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Issue6672DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Issue6672DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Issue6672DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Issue6672DbContext, Task<T>> func)
        {
            T result;
